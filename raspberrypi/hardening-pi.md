...
The Raspberry Pi is a great piece of hardware for small networks, running Pi-hole, or other experiments. It does need some hardening out of the box. Since I hate having to look things up every time, I'm going to write them down.

## Resources
- [Raspberry Pi Hardening Guide](https://chrisapproved.com/blog/raspberry-pi-hardening.html)
- [Improving the Security of Your Raspberry Pi](https://pimylifeup.com/raspberry-pi-security/)
